...
# This configuration creates a highly available and scalable three-tier architecture
...
resource "aws_cloudfront_distribution" "main" {
  origin {
    ...
    origin_id = "s3-origin-${aws_s3_bucket.static_assets.id}"
  ...
  default_cache_behavior {
    ...
    target_origin_id = "s3-origin-${aws_s3_bucket.static_assets.id}"
    forwarded_values {
      query_string = false
      cookies {
        forward = "none"
...
resource "aws_launch_template" "web" {
  ...
  user_data = base64encode(<<-EOF
    ...
    echo "<h1>Welcome to ${var.project_name} Web Tier</h1>" > /var/www/html/index.html
...
resource "aws_launch_template" "app" {
  ...
  user_data = base64encode(<<-EOF
    ...
    mkdir -p /opt/app
    cat > /opt/app/SimpleApp.java << 'JAVA_EOF'
    import java.io.*;
    import java.net.*;
        ...
        public static void main(String[] args) throws IOException {
            ...
            while (true) {
                ...
                String response = "HTTP/1.1 200 OK\r\n" +
                                 ...
                                 "\r\n" +
                                 "<h1>Application Tier Response</h1>" +
                                 "<p>Instance ID: " + System.getenv("AWS_INSTANCE_ID") + "</p>" +
